...
public class Adapter_act extends ArrayAdapter<Items> {
    ArrayList<Items> coding_events;
    public Adapter_act(@NonNull Context context, int resource, @NonNull ArrayList<Items> items) {
