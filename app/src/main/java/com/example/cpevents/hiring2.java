...
public class hiring2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setText("HIRING-UPCOMING");
        ...
        client.get("http://testchallengehunt.appspot.com/v1/all",new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    JSONObject contests1=response.getJSONObject("hiring");
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                client1.get("http://testchallengehunt.appspot.com/v1/all",new JsonHttpResponseHandler(){
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response1) {
                        ...
                        try {
                            JSONObject con = response1.getJSONObject("hiring");
                            ...
                            for (int i = 0; i < act.length(); i++) {
                                ...
                                if(i==position){
                                    ...
                                    Intent intent=new Intent(hiring2.this,Cont_url.class);
