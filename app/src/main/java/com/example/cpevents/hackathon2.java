...
public class hackathon2 extends AppCompatActivity {
    ListView listView;
    ArrayList<Items_hack> list=new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setText("HACKATHON-UPCOMING");
        ...
        final Adapter_hack adapter=new Adapter_hack(this,R.layout.custom_hack,list);
        ...
        client.get("http://testchallengehunt.appspot.com/v1/all",new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    JSONObject contests1=response.getJSONObject("hackathons");
                    String c1jsonobj=contests1.getString("upcoming");
                    JSONArray cactive=new JSONArray(c1jsonobj);
                    if(cactive.length()!=0) {
                        for (int i = 0; i < cactive.length(); i++) {
                            JSONObject cobjactive = cactive.getJSONObject(i);
                            list.add(new Items_hack(cobjactive.getString("host_url"),
                                    ...
                                    cobjactive.getString("end_date"),
                                    cobjactive.getString("start_date"),
                                    cobjactive.getString("location")));
                        }
                    }
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                client1.get("http://testchallengehunt.appspot.com/v1/all",new JsonHttpResponseHandler(){
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response1) {
                        ...
                        try {
                            JSONObject con = response1.getJSONObject("hackathons");
                            ...
                            for (int i = 0; i < act.length(); i++) {
                                ...
                                if(i==position){
                                    ...
                                    Intent intent=new Intent(hackathon2.this,Cont_url.class);
